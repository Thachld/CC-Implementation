...
export default class Lookup extends NavigationMixin(LightningElement) {
    ...
    @api
    getLookupField(uniqueid) {
        let queryItem = '[data-uniqueid="' + uniqueid + '"]';
        let lookup = this.template.querySelector(queryItem)
        return lookup;
    }
    ...
    processSelectionUpdate(isUserInteraction) {
        ...
        if (isUserInteraction) {
            ...
            let details = {
                ...
                'uniqueid' : this._selectuniqueid,
                'selection' : this._curSelection
            }

            this.dispatchEvent(new CustomEvent('selectionchange', { detail: details }));
        }
    }
    ...
    handleResultClick(event) {
        ...
        const uniqueId = event.currentTarget.dataset.uniqueid;
        this._selectuniqueid = uniqueId;
